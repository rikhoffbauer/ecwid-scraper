...
import type { CanonicalProduct, SourceKind } from "./types.ts";
...
export function canonicalFromEcwid(sourceId: string, product: JsonObject): CanonicalProduct {
...
export function canonicalRawProduct(product: CanonicalProduct): JsonObject {
  return {
    ...product.raw,
